...
<style lang="scss">
	...
	.modal-container{
		...
		.modal-content{
			...
			.modal-article{
				padding: 40rpx 30rpx 50rpx;font-size: $fontSizeSm;color: #999;text-align:center;color: #000000;
			}
			.modal-row{
				display: flex;text-align: center;font-size: 24upx;line-height: 100rpx;position: relative;color: #404040;
				.modal-col{
